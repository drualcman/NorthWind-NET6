...
namespace LINQExpressionToSQL
{
    /// <summary>
    /// traducr una expresion desde un metodo a una instruccion sql
    /// </summary>
    public class Translator : ExpressionVisitor
    {
            ...
            else
            {
                    ...
                    constantExpression.Value.GetType()))
                {
                    case TypeCode.DateTime:
                        Builder.Append("'");
                        Builder.Append(
                            ((DateTime)constantExpression.Value)
                            .ToString("o"));
                        Builder.Append("'");
                        break;
                    default:
        ...
        #region Helpers
        /// <summary>
        /// esta clase recibe algo como p => p.id == 5;
        /// </summary>
        ...
        bool IsExpressionContainerFieldMember(
            MemberExpression memberExpression)
        {
            bool Result = false;
            var Field = ExpressionContainer.GetType()
            ...
            {
                var FieldValue =
                    Field.GetValue(ExpressionContainer);
        ...
        bool IsDatePropertyMember(MemberExpression memberExpression)
        {
            ...
            if (memberExpression.Member.DeclaringType ==
                typeof(DateTime) &&
